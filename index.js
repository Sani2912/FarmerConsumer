...
app.post('/registerdo',urlencoded,function(req,res){
    ...
    MongoClient.connect('mongodb://sani:12345@cluster0-shard-00-02.fgwvp.mongodb.net:27017,cluster0-shard-00-00.fgwvp.mongodb.net:27017,cluster0-shard-00-01.fgwvp.mongodb.net:27017/test?ssl=true&replicaSet=atlas-l4dx31-shard-0&authSource=admin&retryWrites=true&w=majority',{ useNewUrlParser: true },function(err,db){
        if(err) throw err;
...
app.post('/logindo',urlencoded,function(req,res){
    ...
    var c=req.body.name;
    MongoClient.connect('mongodb://sani:12345@cluster0-shard-00-02.fgwvp.mongodb.net:27017,cluster0-shard-00-00.fgwvp.mongodb.net:27017,cluster0-shard-00-01.fgwvp.mongodb.net:27017/test?ssl=true&replicaSet=atlas-l4dx31-shard-0&authSource=admin&retryWrites=true&w=majority',function(err,db){
        if(err) throw err;
        var db=db.db('farmerlogindb');
        query={email:a};
        var details=[];
...
app.post("/addp",urlencoded,function(req,res){
    ...
    const newLocal = 'mongodb://sani:12345@cluster0-shard-00-02.fgwvp.mongodb.net:27017,cluster0-shard-00-00.fgwvp.mongodb.net:27017,cluster0-shard-00-01.fgwvp.mongodb.net:27017/test?ssl=true&replicaSet=atlas-l4dx31-shard-0&authSource=admin&retryWrites=true&w=majority';
    MongoClient.connect(newLocal,{ useNewUrlParser: true },function(err,db){
        if(err) throw err;
        var db=db.db('farmerlogindb');
